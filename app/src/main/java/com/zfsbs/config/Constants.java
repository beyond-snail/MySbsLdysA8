...
//
	...
	public static final int PAY_WAY_PREAUTH = 15; //预授权
	public static final int PAY_WAY_AUTHCANCEL = 16; //预授权撤销
	public static final int PAY_WAY_AUTHCOMPLETE = 17; //预授权完成
	public static final int PAY_WAY_VOID_AUTHCOMPLETE = 18; //预授权完成撤销
